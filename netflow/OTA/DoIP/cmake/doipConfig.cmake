...
# set library name
set(LIB_LIBRARIES "doip")
set(LIB_OS_PLATFORM "Linux")

get_filename_component(LIB_CMAKE_DIR "doipConfig.cmake" PATH)
set(LIB_INCLUDE_DIRS "${LIB_CMAKE_DIR}/../../../include/${LIB_LIBRARIES}")

include("${LIB_CMAKE_DIR}/doipTargets.cmake")  # 这个文件是自动生成的
