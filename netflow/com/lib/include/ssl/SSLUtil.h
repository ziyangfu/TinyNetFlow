...
#ifndef COM_LIB_SSL_SSL_UTIL_H
#define COM_LIB_SSL_SSL_UTIL_H
...
public:
     ...
     * @return 公钥证书列表
     */
    static std::vector<std::shared_ptr<X509> > loadPublicKey(const std::string &file_path_or_data,
     ...
     * @return 私钥证书
     */
    static std::shared_ptr<EVP_PKEY> loadPrivateKey(const std::string &file_path_or_data,
                                                    const std::string &passwd = "",
                                                    bool isFile = true);
     ...
     * @return SSL_CTX对象
     */
    static std::shared_ptr<SSL_CTX> makeSSLContext(const std::vector<std::shared_ptr<X509> > &cers,
     ...
     * @return 加密或解密后的数据
     */
    static std::string cryptWithRsaPrivateKey(EVP_PKEY *private_key, const std::string &in_str,
                                              bool enc_or_dec);
