...
void ProtobufCodecLite::send(const osadaptor::net::TcpConnectionPtr &conn,
...
void ProtobufCodecLite::fillEmptyBuffer(osadaptor::net::Buffer* buf,
                                        const google::protobuf::Message& message)
{
  ...
  int32_t len =  hostToNetworkUint32(static_cast<uint32_t>(buf->readableBytes()));
  buf->prepend(&len, sizeof len);
}

void ProtobufCodecLite::onMessage(const osadaptor::net::TcpConnectionPtr& conn,
                                  osadaptor::net::Buffer* buf,
...
bool ProtobufCodecLite::parseFromBuffer(std::string buf, google::protobuf::Message* message)
{
...
void ProtobufCodecLite::defaultErrorCallback(const osadaptor::net::TcpConnectionPtr& conn,
                                             osadaptor::net::Buffer* buf,
