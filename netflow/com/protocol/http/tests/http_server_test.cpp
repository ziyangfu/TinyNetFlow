...
#include "netflow/Com/http/HttpServer.h"
#include "netflow/Com/http/HttpRequest.h"
#include "netflow/Com/http/HttpResponse.h"
...
int main(int argc, char* argv[])
{
    ...
    EventLoop loop;
    HttpServer server(&loop, InetAddr(8000), "dummy");
